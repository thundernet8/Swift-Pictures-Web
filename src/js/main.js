...
(function(factory) {
    ...
    $h = {
        ...
        isIE: function(ver) {
            ...
            if (ver === 10) {
                return new RegExp("msie\\s" + ver, "i").test(
                    navigator.userAgent
                );
            }
        ...
        findFileName: function(filePath) {
            ...
            return filePath
                .split(filePath.substring(sepIndex, sepIndex + 1))
                .pop();
        },
        ...
        setOrientation: function(buffer, callback) {
            var scanner = new DataView(buffer),
                idx = 0,
                value = 1, // Non-rotated is the default
                maxBytes,
                uInt16,
                exifLength;
    ...
    FileInput.prototype = {
        ...
        _init: function(options) {
            ...
            if (self.rtl) {
                ...
                self.previewZoomButtonIcons.prev =
                    self.previewZoomButtonIcons.next;
            ...
            self.dropZoneEnabled =
                $h.hasDragDropSupport() && self.dropZoneEnabled;
            ...
            self.isClickable =
                ...
                self.showPreview &&
                ((self.isUploadable && self.dropZoneEnabled) ||
        ...
        _initTemplateDefaults: function() {
            ...
            tCaption =
                '<div tabindex="500" class="form-control file-caption {class}">\n' +
                '   <div class="file-caption-name"></div>\n' +
                "</div>\n";
            //noinspection HtmlUnknownAttribute
            tBtnDefault =
                '<button type="{type}" tabindex="500" title="{title}" class="{css}" ' +
            ...
            tTagBef2 =
                tTagBef + ' title="{caption}"><div class="kv-file-content">\n';
            tTagAft = "</div>{footer}\n</div>\n";
            tGeneric = "{content}\n";
            tHtml =
                ...
                ">{data}</div>\n";
            tImage =
                '<img src="{data}" class="file-preview-image kv-preview-data" title="{caption}" alt="{caption}" ' +
                $h.STYLE_SETTING +
                ">\n";
            tText =
                ...
                ">{data}</textarea>\n";
            tVideo =
                '<video class="kv-preview-data file-preview-video" width="{width}" ' +
            ...
            tAudio =
                ...
                "\n</audio></div>\n";
            tFlash =
                '<object class="kv-preview-data file-object" type="application/x-shockwave-flash" ' +
                ...
                "\n</object>\n";
            tObject =
                '<object class="kv-preview-data file-object {typeCss}" data="{data}" type="{type}" ' +
                ...
                "\n</object>\n";
            tPdf =
                '<embed class="kv-preview-data" src="{data}" ' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    indicatorLoading:
                        '<i class="glyphicon glyphicon-hand-up text-muted"></i>',
        ...
        _initPreviewCache: function() {
            ...
            self.previewCache = {
                ...
                count: function(all) {
                    return !!self.previewCache.data &&
                    !!self.previewCache.data.content
                        ? all
                          ? self.previewCache.data.content.length
                          : self.previewCache.fetch().length
                        : 0;
                },
                ...
                footer: function(i, isDisabled, size) {
                    ...
                    var config = data.config[i],
                        ...
                        initPreviewShowDel =
                            self.initialPreviewShowDelete || false,
                        showDel = $h.ifSet(
                            "showDelete",
                            config,
                            $h.ifSet("showDelete", fs, initPreviewShowDel)
                        ),
                        showZoom = $h.ifSet(
                            "showZoom",
                            config,
                            $h.ifSet("showZoom", fs, true)
                        ),
                        showDrag = $h.ifSet(
                            "showDrag",
                            config,
                            $h.ifSet("showDrag", fs, true)
                        ),
                        disabled = url === false && isDisabled;
                    actions = self._renderFileActions(
                        false,
                        showDel,
                        showZoom,
                        showDrag,
        ...
        _errorsExist: function() {
            ...
            $err = $(document.createElement("div")).html(
        ...
        _noFilesError: function(params) {
            var self = this,
                label =
                    self.minFileCount > 1 ? self.filePlural : self.fileSingle,
        ...
        _parseError: function(operation, jqXHR, errorThrown, fileName) {
            ...
            var self = this,
                ...
                text =
                    ...
                    jqXHR.responseJSON.error !== undefined
        ...
        _parseFilePreviewIcon: function(content, fname) {
            var self = this,
                icn = self._getPreviewIcon(fname) || self.previewFileIcon,
                out = content;
        ...
        _initClickable: function() {
            ...
            $zone = self.isUploadable
                ? self.$dropZone
                : self.$preview.find(".file-default-preview");
        ...
        _initDragDrop: function() {
            ...
            if (self.isUploadable && self.dropZoneEnabled && self.showPreview) {
                ...
                self._handler(
                    $zone,
                    "dragleave",
                    $.proxy(self._zoneDragLeave, self)
                );
        ...
        _zoneDragEnter: function(e) {
            var self = this,
                hasFiles =
                    $.inArray("Files", e.originalEvent.dataTransfer.types) > -1;
        ...
        _zoneDrop: function(e) {
            ...
            if (
                self.isDisabled ||
                $h.isEmpty(e.originalEvent.dataTransfer.files)
            ) {
                return;
            }
        ...
        _getZoomButton: function(type) {
            var self = this,
                ...
                title =
                    ' title="' +
                    (self.previewZoomButtonTitles[type] || "") +
                    '" ',
                params =
                    title +
                    (type === "close"
        ...
        _setZoomContent: function($frame, animate) {
            var self = this,
                ...
                $zoomPreview = self.$preview.find("#zoom-" + pid);
        ...
        _getPreviewTemplate: function(t) {
            var self = this,
                template = self.previewTemplates[t];
            ...
            settings = $.extend(
                ...
                {},
                {
                    xhr: function() {
                        ...
                        return self._initXhr(
                            xhrobj,
                            previewId,
                            self.getFileStack().length
                        );
                    },
                    url: self.uploadUrl,
                    type: "POST",
                ...
                if ($thumb !== undefined) {
                    if (!allFiles) {
                        ...
                        $thumb.fadeOut("slow", function() {
                            ...
                            self._clearFileInput();
                            $h.cleanZoomCache(
                                self.$preview.find("#zoom-" + $thumb.attr("id"))
                            );
                            $thumb.remove();
                            $div.remove();
                            self._initSortable();
        ...
        _initSuccessThumbs: function() {
            ...
            self
                ._getThumbs($h.FRAMES + ".file-preview-success")
                .each(function() {
                    var $thumb = $(this),
        ...
        _uploadSingle: function(i, allFiles) {
            var self = this,
                ...
                $btnDelete,
                hasPostData =
                    self.filestack.length > 0 ||
                    !$.isEmptyObject(self.uploadExtraData),
                ...
                uploadFailed,
                multiUploadMode = !$h.isEmpty(self.$element.attr("multiple"));
            ...
            if (
                total === 0 ||
                !hasPostData ||
                ($btnUpload && $btnUpload.hasClass("disabled")) ||
                self._abort(params)
            ) {
                return;
            }
                ...
                setTimeout(function() {
                    ...
                    if (self.showPreview) {
                        ...
                        if (len) {
                            ...
                            self.initialPreviewConfig = $h.cleanArray(
                                data.config
                            );
                            self.initialPreviewThumbTags = $h.cleanArray(
                                data.tags
                            );
                        } else {
            ...
            fnSuccess = function(data, textStatus, jqXHR) {
                var pid =
                    self.showPreview && $thumb.attr("id")
                        ? $thumb.attr("id")
                        : previewId;
            ...
            fnError = function(jqXHR, textStatus, errorThrown) {
                var op = self.ajaxOperations.uploadThumb,
                    errMsg = self._parseError(
                        ...
                        jqXHR,
                        errorThrown,
                        allFiles && self.filestack[i].name
                            ? self.filestack[i].name
                            : null
                    );
                uploadFailed = true;
                setTimeout(function() {
                ...
                self._handler($el, "click", function() {
                    ...
                    $frame.fadeOut("slow", function() {
                        ...
                        var filestack = self.getFileStack(true),
                            chk = self.previewCache.count(),
                            len = filestack.length,
                            hasThumb =
                                self.showPreview && self.getFrames().length;
                        if (len === 0 && chk === 0 && !hasThumb) {
                            ...
                            cap =
                                n > 1
                                    ? self._getMsgSelected(n)
                                    : filestack[0]
                                      ? self._getFileNames()[0]
                                      : "";
                            self._setCaption(cap);
                        }
        ...
        _initPreviewActions: function() {
            var self = this,
                ...
                resetProgress = function() {
                    var hasFiles = self.isUploadable
                        ? self.previewCache.count()
                        : self.$element.get(0).files.length;
                ...
                settings = $.extend(
                    ...
                    {},
                    {
                        ...
                        success: function(data, textStatus, jqXHR) {
                            ...
                            $frame.fadeOut("slow", function() {
                                $h.cleanZoomCache(
                                    $preview.find("#zoom-" + $frame.attr("id"))
                                );
                                self._clearObjects($frame);
                                $frame.remove();
                                resetProgress();
                        ...
                        error: function(jqXHR, textStatus, errorThrown) {
                            var op = self.ajaxOperations.deleteThumb,
                                errMsg = self._parseError(
                                    op,
                                    jqXHR,
                                    errorThrown
        ...
        _generatePreviewTemplate: function(
            ...
            var self = this,
                ...
                zoomContent = "",
                config =
                    self.previewSettings[cat] ||
                    self.defaults.previewSettings[cat],
                w = config && config.width ? config.width : "",
                h = config && config.height ? config.height : "",
                footer =
                    foot ||
                    self._renderFileFooter(
                        caption,
                        size,
                        $h.isEmpty(w) ? "auto" : w,
                        isError
                ...
                getContent = function(c, d, zoom, frameCss) {
                    ...
                    if (cat === "object" && !ftype) {
                        $.each(self.defaults.fileTypeSettings, function(
                            key,
                            func
                        ) {
        ...
        _readFiles: function(files) {
            ...
            var self = this,
                ...
                maxPreviewSize =
                    self.maxFilePreviewSize &&
                    parseFloat(self.maxFilePreviewSize),
                canPreview =
                    $preview.length &&
                    (!maxPreviewSize || isNaN(maxPreviewSize)),
                throwError = function(msg, file, previewId, index) {
                    var p1 = $.extend(
                            true,
                            {},
                            self._getOutData({}, {}, files),
                    ...
                    return self.isUploadable
                        ? self._showUploadError(msg, p1)
            ...
            readFile = function(i) {
                ...
                var node = ctr + i,
                    ...
                    msg,
                    fileExtExpr = "",
                    previewData = $h.objUrl.createObjectURL(file),
                    typ,
                    chk,
                    typ1,
                    typ2,
                ...
                if (caption.length === 0) {
                    msg = self.msgInvalidFileName.replace(
                        "{name}",
                        $h.htmlEncode(file.name)
                    );
                    self.isError = throwError(msg, file, previewId, i);
                    return;
                }
                if (!$h.isEmpty(fileExt)) {
                    fileExtExpr = new RegExp(
                        "\\.(" + fileExt.join("|") + ")$",
                        "i"
                    );
                }
        ...
        _updateFileDetails: function(numFiles) {
            var self = this,
                ...
                name =
                    ...
                    (fileStack.length && fileStack[0].name) ||
                    "",
                label = self.slug(name),
                n = self.isUploadable ? fileStack.length : numFiles,
                nFiles = self.previewCache.count() + n,
        ...
        _setProgress: function(p, $el, error) {
            var self = this,
                ...
                template =
                    pct < 100
                        ? self.progressTemplate
                        : error ? self.progressErrorTemplate : t;
            $el = $el || self.$progress;
        ...
        _setAsyncUploadStatus: function(previewId, pct, total) {
            ...
            self._setProgress(
                pct,
                $("#" + previewId).find(".file-thumb-progress")
            );
        ...
        _getFileId: function(file) {
            ...
            relativePath =
                file.webkitRelativePath || file.fileName || file.name || null;
            if (!relativePath) {
                return null;
            }
            return (
        ...
        _validateImage: function(previewId, fname, ftype, fsize, iData) {
            ...
            $img
                .one("load", function() {
                    ...
                    exifObject = window.piexif
                        ? window.piexif.load(iData)
                        : null;
        ...
        _validateAllImages: function() {
            var self = this,
                i,
                counter = { val: 0 },
                numImgs = self.loadedImages.length,
                config,
                fsize,
        ...
        _getResizedImage: function(config, counter, numImgs) {
            ...
            if (self.resizePreference === "width") {
                ratio = chkWidth
                    ? maxWidth / width
                    : chkHeight ? maxHeight / height : 1;
            } else {
                ratio = chkHeight
                    ? maxHeight / height
                    : chkWidth ? maxWidth / width : 1;
            }
            self._resetCanvas();
            width *= ratio;
            height *= ratio;
            ...
            try {
                ...
                msg = self.msgImageResizeException.replace(
                    "{errors}",
                    err.message
                );
                throwError(
        ...
        _setCaption: function(content, isError) {
            ...
            self.$captionContainer
                .find(".file-caption-ellipsis")
                .attr("title", title);
        },
        ...
        _renderMain: function() {
            var self = this,
                ...
                preview = !self.showPreview
                    ? ""
                    : self._getLayoutTemplate("preview").setTokens({
        ...
        _renderThumbProgress: function() {
            ...
            return (
                ...
                self.progressTemplate.setTokens({
                    percent: "0",
        ...
        _change: function(e) {
            ...
            var tfiles = [],
                ...
                files = isDragDrop
                    ...
                    : $el.get(0).files,
                ctr = self.filestack.length,
                isSingleUpload = $h.isEmpty($el.attr("multiple")),
                flagSingle = isSingleUpload && ctr > 0,
                folders = 0,
                fileIds = self._getFileIds(),
            ...
            self._resetErrors();
            len = tfiles.length;
            total = self._getFileCount(
                self.isUploadable ? self.getFileStack().length + len : len
            );
            if (self.maxFileCount > 0 && total > self.maxFileCount) {
                if (!self.autoReplace || len > self.maxFileCount) {
                    n =
                        self.autoReplace && len > self.maxFileCount
                            ? len
                            : total;
                    msg = self.msgFilesTooMany
                        .replace("{m}", self.maxFileCount)
                        .replace("{n}", n);
                ...
                if (!isAjaxUpload || flagSingle) {
                    ...
                    if (
                        isAjaxUpload &&
                        ctr === 0 &&
                        (!self.previewCache.count() || self.overwriteInitial)
                    ) {
        ...
        disable: function() {
            ...
            self.$container
                .find(
                    ".btn-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button"
                )
                .attr("disabled", true);
            self._initDragDrop();
            return self.$element;
